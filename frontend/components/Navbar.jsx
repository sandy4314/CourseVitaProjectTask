...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-blue-600 to-blue-800 py-3 shadow-lg">
        <div className="px-5 mx-auto flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-0">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white text-lg sm:text-xl font-semibold">
              {role === 'admin' ? 'Team Lead Dashboard' : 'Employee Dashboard'}
            </span>
          </div>
